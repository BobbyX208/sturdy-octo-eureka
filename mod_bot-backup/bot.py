...
class ModBot(commands.Bot):
    """Moderation bot for SimCoin - separate token, same database."""
    
    def __init__(self):
        """Initialize mod bot with minimal intents."""
    ...
    async def on_ready(self) -> None:
        """Called when mod bot is ready."""
        self.logger.info(f"Mod Bot is ready!")
    ...
    async def on_application_command_error(
        ...
        """Global error handler for mod commands."""
        try:
