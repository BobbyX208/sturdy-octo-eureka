...
class InvitesCog(commands.Cog):
    """Invite tracker with rewards for both inviter and invitee."""
    ...
    async def on_member_join(self, member: discord.Member):
        """Track new members and reward inviter."""
    ...
    async def on_member_remove(self, member: discord.Member):
        """Handle member leaving - adjust invite stats."""
        pass
    ...
    async def weekly_leaderboard(self):
        """Post weekly invite leaderboard."""
