...
class TicketDropdown(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        overwrites = {
            ...
            interaction.guild.get_role(Config.MOD_ROLE_ID): discord.PermissionOverwrite(read_messages=True, send_messages=True) if Config.MOD_ROLE_ID else None
        }
        ...
        conn = await interaction.client.db.acquire()
        try:
            await conn.execute("""
            ...
            await interaction.client.db.release(conn)
...
class TicketView(discord.ui.View):
    """Ticket creation view with dropdown."""
